...
import { getUserCartThunk, removeCartProductThunk, placeUserOrderThunk } from '../../store/products';
import './index.css';
...
const ShoppingCart = () => {
    ...
    const handleQtyChange = (value, productTitle) => {
        setQuantity(prev => {
    ...
    const placeOrder = async () => {
        ...
        const success = await dispatch(placeUserOrderThunk(orderedItems));
                            ...
                            >
                                ...
                                <div className='item-quantity__container'>
                                    <QuantityPicker
                                        ...
                                        onChange={(value) => handleQtyChange(value, item.title)}
                                    />
                                    <button
